      ...
      <div class="content-wrapper">
       ...
       <div class="box box-success box-solid">
                <div class="box-header with-border">
                  <h3 class="box-title">Dues Payment</h3>
                  <div class="box-tools pull-right">
                    <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                  </div><!-- /.box-tools -->
                </div><!-- /.box-header -->
                <div class="box-body">
                 <p>Please click on pay dues link to pay a member dues to his account</p>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
		  ...
		  $members->get_members_dues($institutes_id,$admin_id);
		   ?>
