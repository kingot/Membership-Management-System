      ...
      <div class="content-wrapper">
       ...
       <div class="box box-success box-solid">
                <div class="box-header with-border">
                  <h3 class="box-title">Live Search [ <span style="color:yellow">For Paid Dues Members </span>]</h3>
                  <div class="box-tools pull-right">
                    <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                  </div><!-- /.box-tools -->
                </div><!-- /.box-header -->
                <div class="box-body">
                 <p>Please enter student number in the search box below. Found out who have paid his semester dues.</p>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
		  ...
		  $members->get_members($institutes_id,$admin_id);*/
           ...
           <form  method="post" class="sidebar-form">
            <div class="input-group">
              <input type="text" id="search_dues_paid" class="form-control" placeholder="Search By Student Number">
              <span class="input-group-btn">
                <button type="button"  id="search-btn" class="btn btn-flat"><i class="fa fa-search"></i></button>
              </span>
            </div>
          </form>
          <div id="search_results_dues_paid"></div>
