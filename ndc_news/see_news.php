                ...
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="../index.php"><img
                                src="../res/images/logo/ndc1.jpg" alt="logo"><span class="logo_text1">N</span><span class="logo_text2">D</span><span class="logo_text3">C</span> - TEIN CHAPTERS</a>
                    </div>
...
<?php
                       ...
                       $new_all_view= new news_all_views;
                       $new_all_view->newsallview();          
              }   
    ?>               
                    </div>
            ...
            <div class="container">
                <div class="text-center">
                    ...
                    <p class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="100ms">
                        Borrow, Save, Convert, Transfer, Get Account Insight, Pay Bills, Shop around the world!
                    </p>
                        <div id="about1"></div>
                    <p class="wow fadeInUp" data-wow-duration="300ms" data-wow-delay="200ms">
                        <a class="btn btn-primary btn-lg" href="#">Create TEIN Chapter Account</a> 
                        </p>
        ...
        <section id="animated-number">
            <div class="container">
                <div class="section-header">
                    ...
                    <p class="text-center wow fadeInDown">
                        Our Online Registration system gives you vast information</br>
                        and insight about your number and still growing number.                        
                    </p>
                </div>
                ...
                <div class="row text-center">
                    <div class="col-sm-3 col-xs-6">
                        <div class="wow fadeInUp" data-wow-duration="400ms" data-wow-delay="0ms">
                            <div class="animated-number" data-digit="2750"  data-duration="1000">600</div>
                            <strong>REGISTERED MEMBERS</strong>
                        </div>
                    </div>
                    <div class="col-sm-3 col-xs-6">
                        <div class="wow fadeInUp" data-wow-duration="400ms" data-wow-delay="100ms">
                            <div class="animated-number" data-digit="1500" data-duration="1000">1500</div>
                            <strong>DUES PAYED</strong>
                        </div>
                    </div>
                    <div class="col-sm-3 col-xs-6">
                        <div class="wow fadeInUp" data-wow-duration="400ms" data-wow-delay="200ms">
                            <div class="animated-number" data-digit="12" data-duration="1000">160</div>
                            <strong>TEIN CHAPTERS REGISTERED </strong>
                        </div>
                    </div>
                    <div class="col-sm-3 col-xs-6">
                        <div class="wow fadeInUp" data-wow-duration="400ms" data-wow-delay="300ms">
                            <div class="animated-number" data-digit="787" data-duration="1000">3420</div>
                            <strong>what do i do with this</strong>
                        </div>
                    </div>
                </div>
            </div>
